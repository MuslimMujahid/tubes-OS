...
ld86 -o kernel -d kernel.o kernel_asm.o mat.o text.o folderIO.o folderIO_extra.o
...
ld86 -o shell -d shell.o lib_asm.o mat.o text.o fileIO.o folderIO.o folderIO_extra.o
